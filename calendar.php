<!DOCTYPE html>
<html>
<script src= "ticketmaste.js"></script>
  <body>
    <div id="zipcode1" w-type="event-discovery" w-tmapikey="9og4mkzbjwQKp75PFbmG3icLDt1UFk7a" w-googleapikey="YOUR_GOOGLE_API_KEY"
    w-keyword="" w-theme="grid" w-colorscheme="light" w-width="100%" w-height="550" w-size="100" w-border="2"
    w-borderradius="4" w-postalcode="" w-radius="25" w-city="" w-period="week" w-layout="fullwidth" w-attractionid="" w-promoterid=""
  ...
  <textarea id="zipcode" rows = "1" cols = "20"> Enter your zipcode</textarea>
  	<button onclick="getZip()">Submit</button>
